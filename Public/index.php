        ...
        case 'forgot.send':
            ...
            Flash::setSuccess(
                'Si el correo está registrado y la cuenta está activa, ' .
                    'te enviaremos un correo con tu contraseña temporal.'
            );
            Flash::setMessage(
                'Si el correo no se encuentra registrado, ' .     'recibirás un mensaje con tu contraseña temporal.'
            );
            View::redirect('auth.forgot');
            break;
...
{
    $templateFile = __DIR__ . '/../Infrastructure/Entrypoints/Web/Presentation/Views/email/forgot-password.php';
    ob_start();
