...
final class UserController
{
    ...
    public function __construct(CreateUserUseCase $createUserUseCase, UpdateUserUseCase $updateUserUseCase, GetUserByIdUseCase $getUserByIdUseCase, GetAllUsersUseCase $getAllUsersUseCase, DeleteUserUseCase $deleteUserUseCase, UserWebMapper $mapper)
    {
    ...
    /** * @return UserResponse[] */ public function index(): array
    {
