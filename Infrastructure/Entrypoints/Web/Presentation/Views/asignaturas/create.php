...
<form method="POST" action="?route=asignaturas.store">
    <div class="form-group">
        ...
        <input type="text" id="nombre" name="nombre" value="<?= htmlspecialchars($old['nombre'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="form-group">
        ...
        <input type="text" id="nombreCompleto" name="nombreCompleto" value="<?= htmlspecialchars($old['nombreCompleto'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="form-group">
        ...
        <textarea id="descripcion" name="descripcion"><?= htmlspecialchars($old['descripcion'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
    ...
    <div class="form-group">
        ...
        <input type="text" id="areaConocimiento" name="areaConocimiento" value="<?= htmlspecialchars($old['areaConocimiento'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="form-group">
        ...
        <input type="text" id="carrera" name="carrera" value="<?= htmlspecialchars($old['carrera'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="form-group">
        ...
        <input type="number" id="numeroCreditos" name="numeroCreditos" value="<?= htmlspecialchars($old['numeroCreditos'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="form-group">
        ...
        <textarea id="contenidoTematico" name="contenidoTematico"><?= htmlspecialchars($old['contenidoTematico'] ?? '', ENT_QUOTES, 'UTF-8') ?></textarea>
    ...
    <div class="form-group">
        ...
        <input type="number" id="semestre" name="semestre" value="<?= htmlspecialchars($old['semestre'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
    ...
    <div class="form-group">
        ...
        <input type="text" id="profesor" name="profesor" value="<?= htmlspecialchars($old['profesor'] ?? '', ENT_QUOTES, 'UTF-8') ?>">
